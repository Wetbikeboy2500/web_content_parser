...
Parser get input => ((char('l') | char('s') | char('b') | char('n')).token() & rawInputSingleQuote.trim()) | (safeChars.plus().flatten().trim() & digitInput.optional()).separatedBy(char('.'), includeSeparators: false);
